...
Based on Blake Blackshear's [Frigate](https://github.com/blakeblackshear/frigate.git), [hyperlpr3](https://github.com/szad670401/HyperLPR) is used for Chinese license plate recognition, while the original Paddle license plate recognition is retained to support other countries and regions. Referencing [Rethinking_of_PAR](https://github.com/valencebond/Rethinking_of_PAR.git), custom datasets were used to train pedestrian/vehicle ReID models for identifying pedestrian/vehicle features.
