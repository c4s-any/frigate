...
// import FrigatePlusSettingsView from "@/views/settings/FrigatePlusSettingsView"; // Disabled - not using Frigate+ features
...
const allSettingsViews = [
  ...
  "users",
  "notifications",
  // "frigateplus", // Disabled - not using Frigate+ features
] as const;
