  ...
  useEffect(() => {
    ...
    if (container && !editorRef.current) {
      editorRef.current = monaco.editor.create(container, {
        ...
        theme: (systemTheme || theme) == "dark" ? "vs-dark" : "vs-dark",
      });
    ...
    <div className="absolute bottom-2 left-0 right-0 top-2 md:left-2">
      <div className="relative h-full overflow-hidden">
        <div className="mr-1 flex items-center justify-between">
          <div className="scroll-m-20 text-large font-semibold tracking-tight transition-colors">
            配置编辑器
          </div>
          <div className="flex flex-row gap-1">
            ...
            >
              ...
              <span className="hidden md:block">拷贝配置</span>
            </Button>
            <Button
              size="sm"
              className="flex items-center gap-2"
            ...
            >
              ...
              <span className="hidden md:block">保存 & 重启</span>
            </Button>
            <Button
              size="sm"
              className="flex items-center gap-2"
            ...
            >
              ...
              <span className="hidden md:block">仅保存</span>
            </Button>
          </div>
        </div>
