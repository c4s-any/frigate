...
function Logs() {
  ...
  useEffect(() => {
    document.title = `${logService[0].toUpperCase()}${logService.substring(1)} 日志 - Frigate`;
  }, [logService]);
    ...
    <div className="flex size-full flex-col p-2">
      ...
      <div className="relative flex h-11 w-full items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <div className="hidden text-primary md:block">下载</div>
          </Button>
      ...
      <div className="font-mono relative my-2 flex size-full flex-col overflow-hidden whitespace-pre-wrap rounded-md border border-secondary bg-background_alt text-sm sm:p-2">
        <div className="grid grid-cols-5 *:px-2 *:py-3 *:text-sm *:text-primary/40 sm:grid-cols-8 md:grid-cols-12">
          <div className="flex items-center p-1 capitalize">类型</div>
          <div className="col-span-2 flex items-center sm:col-span-1">
            时间戳
          </div>
          <div className="col-span-2 flex items-center">标签</div>
