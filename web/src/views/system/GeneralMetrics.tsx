    ...
    <>
      ...
      <div className="scrollbar-container mt-4 flex size-full flex-col overflow-y-auto">
        ...
        >
          {statsHistory.length != 0 ? (
            <div className="rounded-lg bg-background_alt p-2.5 md:rounded-2xl">
              <div className="mb-5">检测器推理速度</div>
          ...
          {statsHistory.length != 0 ? (
            <div className="rounded-lg bg-background_alt p-2.5 md:rounded-2xl">
              <div className="mb-5">检测器 CPU 使用</div>
          ...
          {statsHistory.length != 0 ? (
            <div className="rounded-lg bg-background_alt p-2.5 md:rounded-2xl">
              <div className="mb-5">检测器内存使用</div>
              ...
              {statsHistory.length != 0 ? (
                <>
                  {gpuEncSeries && gpuEncSeries?.length != 0 && (
                    <div className="rounded-lg bg-background_alt p-2.5 md:rounded-2xl">
                      <div className="mb-5">GPU 编码器</div>
              ...
              {statsHistory.length != 0 ? (
                <>
                  {gpuDecSeries && gpuDecSeries?.length != 0 && (
                    <div className="rounded-lg bg-background_alt p-2.5 md:rounded-2xl">
                      <div className="mb-5">GPU 解码器</div>
        ...
        <div className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2">
          {statsHistory.length != 0 ? (
            <div className="rounded-lg bg-background_alt p-2.5 md:rounded-2xl">
              <div className="mb-5">进程 CPU 使用</div>
