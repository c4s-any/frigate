...
export default function MasksAndZonesView({
  ...
  const handleCancel = useCallback(() => {
    ...
    document.title = "遮罩和防区编辑器 - Frigate";
  ...
  const handleCopyCoordinates = useCallback(
    (index: number) => {
      if (allPolygons && scaledWidth && scaledHeight) {
        ...
        toast.success(`已将 ${poly.name} 的坐标复制到剪贴板。`);
      } else {
        toast.error("无法将坐标复制到剪贴板。");
      }
    },
                      ...
                      <div className="my-3 flex flex-row items-center justify-between">
                        <HoverCard>
                          <HoverCardTrigger asChild>
                            <div className="text-md cursor-default">防区</div>
                          </HoverCardTrigger>
                          <HoverCardContent>
                            <div className="my-2 flex flex-col gap-2 text-sm text-primary-variant">
                              <p>
                                防区允许您定义画面的特定区域，以便确定某个目标是否在特定区域内。
                              </p>
                              <div className="flex items-center text-primary">
                                <Link
                                  to="https://c4s.tech/docs/Frigate/configuration/zones"
                                  target="_blank"
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>添加防区</TooltipContent>
                        </Tooltip>
                      </div>
                      {allPolygons
                      ...
                      <div className="my-3 flex flex-row items-center justify-between">
                        <HoverCard>
                          ...
                          <HoverCardContent>
                            <div className="my-2 flex flex-col gap-2 text-sm text-primary-variant">
                              <p>
                                动态遮罩用于防止不必要的动态类型触发检测。过度遮蔽会增加跟踪目标的难度。
                              </p>
                              <div className="flex items-center text-primary">
                                <Link
                                  to="https://c4s.tech/docs/Frigate/configuration/masks#motion-masks"
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="inline"
                                >
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>添加动态遮罩</TooltipContent>
                        </Tooltip>
                      </div>
                      {allPolygons
                        .flatMap((polygon, index) =>
                      ...
                      <div className="my-3 flex flex-row items-center justify-between">
                        <HoverCard>
                          ...
                          <HoverCardContent>
                            <div className="my-2 flex flex-col gap-2 text-sm text-primary-variant">
                              <p>
                                目标遮罩用于根据位置过滤特定目标类型的误报。
                              </p>
                              <div className="flex items-center text-primary">
                                <Link
                                  to="https://c4s.tech/docs/Frigate/configuration/masks#object-filter-masks"
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="inline"
                                >
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>添加目标遮罩</TooltipContent>
                        </Tooltip>
                      </div>
                      {allPolygons
                        .flatMap((polygon, index) =>
