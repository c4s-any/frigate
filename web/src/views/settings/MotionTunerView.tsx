    ...
    <div className="flex size-full flex-col md:flex-row">
      ...
      <div className="scrollbar-container order-last mb-10 mt-2 flex h-full w-full flex-col overflow-y-auto rounded-lg border-[1px] border-secondary-foreground bg-background_alt p-2 md:order-none md:mb-0 md:mr-2 md:mt-0 md:w-3/12">
        ...
        <div className="my-3 space-y-3 text-sm text-muted-foreground">
          <p>
            Frigate 使用动态侦测作为第一道检查程序，以查看画面中是否有任何值得用目标检测来检查的事情发生。
          </p>

          <div className="flex items-center text-primary">
            <Link
              to="https://c4s.tech/docs/Frigate/configuration/motion_detection"
              target="_blank"
        ...
        <div className="flex w-full flex-col space-y-6">
          ...
          <div className="mt-2 space-y-6">
            <div className="space-y-0.5">
              ...
              <div className="my-2 text-sm text-muted-foreground">
                <p>
                  轮廓区域值用于确定哪些变化的像素组符合动态条件。<em>默认值：10</em>
                </p>
              </div>
            </div>
            <div className="flex flex-row justify-between">
          ...
          <div className="flex flex-row items-center justify-between">
            <div className="space-y-0.5">
              <Label htmlFor="improve-contrast">提高对比度</Label>
              <div className="text-sm text-muted-foreground">
                提高黑暗场景的对比度 <em>默认值：ON</em>
              </div>
            </div>
            <Switch
              id="improve-contrast"
