      ...
      <div className="flex w-full flex-row">
        <div className="flex w-full flex-col gap-3">
          <div className="flex flex-col gap-1.5">
            ...
            <div className="flex flex-row items-center gap-2 text-sm smart-capitalize min-w-0">
              {getIconForLabel(search.label, "size-4 text-primary")}
              {getTranslatedLabel(search.label)}
              {search.sub_label && (
                <Tooltip>
                  <TooltipTrigger asChild>
                    <span className="truncate max-w-[150px]" title={search.sub_label}>
                      {` (${search.sub_label})`}
                    </span>
                  </TooltipTrigger>
                  <TooltipPortal>
                    <TooltipContent>
                      <p className="max-w-[300px] break-words">{search.sub_label}</p>
                    </TooltipContent>
                  </TooltipPortal>
                </Tooltip>
              )}
