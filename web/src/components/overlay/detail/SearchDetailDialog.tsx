  ...
  return (
    <Overlay open={isOpen} onOpenChange={handleOpenChange}>
      ...
      >
        <Header>
          <Title>目标详情</Title>
          <Description className="sr-only">目标详情</Description>
        </Header>
        <ScrollArea
            ...
            >
              {Object.values(searchTabs).map((item) => (
                ...
                >
                  ...
                  <div className="capitalize">{en2zh_item(item)}</div>
                </ToggleGroupItem>
              ))}
            </ToggleGroup>
    ...
    <div className="flex flex-col gap-5">
      <div className="flex w-full flex-row">
        <div className="flex w-full flex-col gap-3">
              ...
              <div className="flex flex-row items-center gap-1">
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-80">
                    最高分是目标最高中值分数，因此可能与搜索结果缩略图上显示的分数不同。
                  </PopoverContent>
                </Popover>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-1.5">
            <div className="text-sm text-primary/40">摄像机</div>
      ...
      <div className="flex flex-col gap-1.5">
        <div className="text-sm text-primary/40">描述</div>
        <Textarea
          className="h-64"
          placeholder="目标描述"
          value={desc}
                ...
                <CardContent className="flex flex-col items-center justify-between gap-3 p-2 md:flex-row">
                  <div className={cn("flex flex-col space-y-3")}>
                    ...
                    <div className="text-sm text-muted-foreground">
                      您想要避开的位置中的物理不是误报。将它们作为误报提交会使模型混乱。
                    </div>
                  </div>
      ...
      {reviewItem && (
        ...
        >
          <Tooltip>
            ...
            <TooltipPortal>
              <TooltipContent>浏览历史</TooltipContent>
            </TooltipPortal>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger asChild>
