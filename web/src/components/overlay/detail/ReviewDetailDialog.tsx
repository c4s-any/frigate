                    ...
                    <div className="scrollbar-container flex max-h-32 flex-col items-start gap-2 overflow-y-auto text-sm smart-capitalize">
                      {events?.map((event) => {
                        return (
                          <div
                            key={event.id}
                            className="flex flex-row items-center gap-2 smart-capitalize min-w-0"
                          >
                            {getIconForLabel(
                              event.label,
                              "size-3 text-primary",
                            ...
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <span className="truncate max-w-[150px]" title={event.sub_label ?? event.label.replaceAll("_", " ")}>
                                  {event.sub_label ??
                              ...
                              <TooltipPortal>
                                <TooltipContent>
                                  <p className="max-w-[300px] break-words">{event.sub_label ?? event.label.replaceAll("_", " ")}</p>
                                </TooltipContent>
                              </TooltipPortal>
                            </Tooltip>
                            <Tooltip>
