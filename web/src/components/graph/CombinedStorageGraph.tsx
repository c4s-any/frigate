    ...
    <div className="flex w-full flex-col gap-2.5">
      ...
      <div className="custom-legend">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead>摄像机</TableHead>
              <TableHead>已用存储</TableHead>
              <TableHead>占已用总量的百分比</TableHead>
                  ...
                  {item.name === "Unused" && (
                    <Popover>
                      ...
                      <PopoverContent className="w-80">
                        ...
                        如果您的硬盘上除了 Frigate 的录像外还存储了其他文件，
                        则此值可能无法准确显示 Frigate 可用的可用空间。
                        Frigate 不会跟踪其录像之外的存储使用情况。
                        </div>
                      </PopoverContent>
                    </Popover>
                  )}
