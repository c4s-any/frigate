    ...
    def lpr_process(
        ...
        if dedicated_lpr:
            ...
            if (
                ...
                and obj_data.get("label") != "license plate"
            ):
                logger.debug(
            ...
            if "license plate" not in self.config.cameras[camera].objects.track:
                ...
                if obj_data.get("label") in ["car", "motorcycle"]:
                    ...
                    for attr in attributes:
                        if attr.get("label") != "license plate":
                            continue
                ...
                if obj_data.get("label") == "license plate":
        ...
        if (
            dedicated_lpr
            and "license plate" not in self.config.cameras[camera].objects.track
        ):
            plate_id = None
