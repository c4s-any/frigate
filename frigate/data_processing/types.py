...
class DataProcessorMetrics:
    ...
    preid_speed: Synchronized
    preid_pps: Synchronized
    vreid_speed: Synchronized
    vreid_pps: Synchronized
    ...
    def __init__(self):
        ...
        self.preid_speed = mp.Value("d", 0.0)
        self.preid_pps = mp.Value("d", 0.0)
        self.vreid_speed = mp.Value("d", 0.0)
        self.vreid_pps = mp.Value("d", 0.0)
