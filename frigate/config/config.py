...
class FrigateConfig(FrigateBaseModel):
    ...
    # LPR配置
    hyperlpr: hyperLpr3Config = Field(title="Hyperlpr3 Configuration.")

    # Vehicle ReID配置
    vreid: vReIDConfig = Field(title="Vehicle ReID Configuration.")

    # Pedestrian ReID配置
    preid: pReIDConfig = Field(title="Pedestrian ReID Configuration.")
