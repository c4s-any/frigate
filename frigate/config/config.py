...
from .hyperlpr import hyperLpr3Config
from .vreid import vReIDConfig
from .preid import pReIDConfig
...
class FrigateConfig(FrigateBaseModel):
    ...
    # Hyperlpr3配置
    hyperlpr: hyperLpr3Config = Field(default_factory=hyperLpr3Config, title="Hyperlpr3 Configuration.")

    # Vehicle ReID配置
    vreid: vReIDConfig = Field(default_factory=vReIDConfig, title="Vehicle ReID Configuration.")

    # Pedestrian ReID配置
    preid: pReIDConfig = Field(default_factory=pReIDConfig, title="Pedestrian ReID Configuration.")
