...
import os
from frigate.detectors.plugins.init_session import ini_onnx_session
...
class ONNXDetector(DetectionApi):
    ...
    def __init__(self, detector_config: ONNXDetectorConfig):
        ...
        if path.endswith(".m"):
            ...
            self.model = ini_onnx_session(key_path, path, providers, options)
            logger.info("encrypted onnx model loaded.")
        else:
