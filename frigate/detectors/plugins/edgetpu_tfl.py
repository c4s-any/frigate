...
from frigate.detectors.plugins.init_crypt_session import init_tflite_session
...
class EdgeTpuTfl(DetectionApi):
    ...
    def __init__(self, detector_config: EdgeTpuDetectorConfig):
        ...
        try:
            ...
            print(detector_config.model.path)

            if detector_config.model.path.endswith(".m"):
                self.interpreter = init_tflite_session(detector_config.model.path, [edge_tpu_delegate])
            else:
